...
export default function BetModal({
  ...
  const potentialPayout =
    winningPool > 0 ? (parsed / winningPool) * adjustedPool : 0;
          ...
          >
            ...
            <div className="flex items-start justify-between px-6 pt-5 pb-4">
              <div>
                ...
                <p className="text-white/35 text-sm mt-0.5 line-clamp-1 max-w-[280px]">
                  {market.question}
                </p>
              </div>
              <button
                onClick={handleClose}
                className="w-8 h-8 rounded-xl bg-white/[0.05] hover:bg-white/[0.09] flex items-center justify-center text-white/40 hover:text-white transition-all ml-3 shrink-0"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {(["UP", "DOWN"] as const).map((dir) => {
                        ...
                        const pct =
                          totalPool > 0
                            ? ((poolAmt / totalPool) * 100).toFixed(0)
                            : "50";
                        return (
                          <button
                            key={dir}
                            ...
                            >
                              {isUp ? (
                                ...
                                <TrendingDown
                                  className={clsx(
                                    "w-5 h-5",
                                    selected ? "text-red-400" : "text-white/25"
                                  )}
                                />
                              )}
                            </div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1.5 px-4 pb-3">
                          ...
                          <span className="text-[#28cc95]/80 text-xs font-semibold">
                            CBTC
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="relative">
                      <div
                        ...
                        style={{
                          ...
                          border: "1px solid rgba(40,204,149,0.15)"
                        }}
                      />
